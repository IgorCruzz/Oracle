...
var account_model_exports = {};
__export(account_model_exports, {
  accountAttributes: () => accountAttributes,
  default: () => account_model_default
});
module.exports = __toCommonJS(account_model_exports);
...
var accountModel = (sequelize) => {
  const Model = sequelize.define("Account", accountAttributes, { paranoid: true });
