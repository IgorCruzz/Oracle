    ...
    content: [
      {
        columns: [
          {
            image: resolve(__dirname, '..', '..', 'utils', 'img', 'ieea.png'),
            width: 70,
            height: 20,
            margin: [0, 30, 20, 5],
          },
          ...
          {
            image: resolve(__dirname, '..', '..', 'utils', 'img', 'logo.png'),
            width: 100,
            height: 50,
            margin: [0, 5, 20, 5],
          },
          ...
          {
            image: resolve(__dirname, '..', '..', 'utils', 'img', 'rj.png'),
            width: 100,
            height: 50,
            margin: [0, 5, 20, 5],
          },
          {
            image: resolve(__dirname, '..', '..', 'utils', 'img', 'puc.jpg'),
            width: 70,
            height: 50,
            margin: [0, 5, 20, 5],
          },
