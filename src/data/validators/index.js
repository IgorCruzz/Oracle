...
export * from './Category/updateCategory.validator';
export * from './Category/findCategories.validator';
export * from './Category/findCategory.validator';

// PROGRAM
export * from './Program/createProgram.validator';
...
export * from './Program/findProgram.validator';
...
export * from './Region/findRegions.validator';
...
export * from './City/findCities.validator';
...
export * from './Jurisdiction/findJurisdictions.validator';
...
export * from './Document/removeUploadDocument.validator';
// USER
export * from './User/createUser.validator';
export * from './User/deleteUser.validator';
...
export * from './MediaTimelapse/downloadMediaTimelapse.validator';
