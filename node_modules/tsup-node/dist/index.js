...
var require_acorn = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
...
var require_xhtml = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  module.exports = {
    quot: '"',
    amp: "&",
    apos: "'",
...
var require_acorn_jsx = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  "use strict";
...
var require_regjsgen = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  /*!
   * regjsgen 0.5.2
...
// node_modules/.pnpm/regjsparser@0.6.9/node_modules/regjsparser/parser.js
var require_parser = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  (function() {
...
var require_regenerate = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
...
var require_unicode_canonical_property_names_ecmascript = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
...
var require_unicode_property_aliases_ecmascript = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
...
var require_unicode_match_property_ecmascript = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  "use strict";
...
var require_mappings = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  module.exports = new Map([
...
var require_unicode_match_property_value_ecmascript = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  "use strict";
...
var require_iu_mappings = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  module.exports = new Map([
    [75, 8490],
    [83, 383],
    [107, 8490],
...
var require_character_class_escape_sets = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports) => {
  "use strict";
...
var require_rewrite_pattern = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  "use strict";
...
var require_buble_cjs = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports) => {
  "use strict";
  ...
  var MagicString = _interopDefault(_chunk5LOHBVWKjs.require_magic_string_cjs.call(void 0, ));
...
var require_string_argv = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports) => {
  "use strict";
...
var require_consola = _chunkAV6ARAKLjs.__commonJS.call(void 0, (exports, module) => {
  "use strict";
  function u(u2) {
  ...
  var _ = class {
    constructor(u2 = {}) {
      ...
      for (const u3 in this._types) {
        const D2 = _chunkAV6ARAKLjs.__objSpread.call(void 0, _chunkAV6ARAKLjs.__objSpread.call(void 0, {type: u3}, this._types[u3]), this._defaults);
    ...
    _logFn(u2, D2, e2) {
      ...
      const r2 = (u3 = false) => {
        ...
        if (this._lastLog && D3 > 0) {
          ...
          D3 > 1 && u4.push(`(repeated ${D3} times)`), this._log(_chunkAV6ARAKLjs.__objSpread.call(void 0, _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, this._lastLog), {args: u4})), this._lastLogCount = 1;
        }
        if (u3) {
  ...
  }, _chunkAV6ARAKLjs.__objSpread.call(void 0, _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, _u), {level: {enumerable: true, get() {
...
// src/index.ts
var import_buble = _chunkAV6ARAKLjs.__toModule.call(void 0, require_buble_cjs());
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({filter: /\.css$/}, async (args) => {
        ...
        const postcss = _chunk5LOHBVWKjs.getPostcss.call(void 0, );
        if (!postcss) {
          return {
            errors: [
              {
        ...
        const result = await (postcss == null ? void 0 : postcss.default(plugins).process(contents, _chunkAV6ARAKLjs.__objSpread.call(void 0, _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, options), {from: args.path})));
        return {
          contents: result.css,
          loader: "css"
        };
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({filter: /\.svelte$/}, async (args) => {
        svelte = svelte || _chunk5LOHBVWKjs.localRequire.call(void 0, "svelte/compiler");
        if (!svelte) {
          return {
...
// src/index.ts
var import_string_argv = _chunkAV6ARAKLjs.__toModule.call(void 0, require_string_argv());
var import_consola = _chunkAV6ARAKLjs.__toModule.call(void 0, require_consola());
...
async function runEsbuild(options, {format, css}) {
  const pkg = await _chunk5LOHBVWKjs.loadPkg.call(void 0, process.cwd());
  ...
  const env = _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, options.env);
  if (options.replaceNodeEnv) {
    env.NODE_ENV = options.minify || options.minifyWhitespace ? "production" : "development";
  }
  _chunk5LOHBVWKjs.log.call(void 0, format, "info", "Build start");
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      define: _chunkAV6ARAKLjs.__objSpread.call(void 0, _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, options.define), Object.keys(env).reduce((res2, key) => {
        return _chunkAV6ARAKLjs.__objSpread.call(void 0, _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, res2), {
    ...
    _chunk5LOHBVWKjs.log.call(void 0, format, "error", "Build failed");
    throw error;
  }
  ...
  if (result && result.outputFiles) {
    ...
    _chunk5LOHBVWKjs.log.call(void 0, format, "success", `Build success in ${Math.floor(timeInMs)}ms`);
    const {transform} = await Promise.resolve().then(() => _chunkAV6ARAKLjs.__toModule.call(void 0, require("sucrase")));
    await Promise.all(result.outputFiles.map(async (file) => {
      ...
      if (comeFromSource) {
        if (options.babel) {
          const babel = _chunk5LOHBVWKjs.getBabel.call(void 0, );
          if (babel) {
            contents = await babel.transformAsync(contents, {
              filename: file.path
            }).then((res2) => (res2 == null ? void 0 : res2.code) || contents);
          } else {
            throw new (0, _chunkJXWWLNOTjs.PrettyError)(`@babel/core is not found in ${process.cwd()}`);
          }
        }
        if (options.target === "es5") {
          try {
            ...
            throw new (0, _chunkJXWWLNOTjs.PrettyError)(`Error compiling to es5 target:
${error.snippet}`);
          }
        }
        if (splitting && format === "cjs") {
          ...
          contents = _chunk5LOHBVWKjs.rewriteImportMetaUrl.call(void 0, contents, _path.basename.call(void 0, file.path));
        }
      }
...
var normalizeOptions = async (optionsFromConfigFile, optionsOverride) => {
  var _a, _b;
  const options = _chunkAV6ARAKLjs.__objSpread.call(void 0, _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, optionsFromConfigFile), optionsOverride);
  const input = options.entryPoints;
  if (input) {
    options.entryPoints = await _globby2.default.call(void 0, input);
  } else {
    throw new (0, _chunkJXWWLNOTjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (!options.entryPoints || options.entryPoints.length === 0) {
    throw new (0, _chunkJXWWLNOTjs.PrettyError)(`Cannot find ${input}`);
  } else {
    _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", `Building entry: ${options.entryPoints.join(", ")}`);
  }
  options.outDir = options.outDir || "dist";
  if (!options.format) {
    options.format = ["cjs"];
  }
  const tsconfig = await _chunk5LOHBVWKjs.loadTsConfig.call(void 0, process.cwd());
  if (tsconfig.path && tsconfig.data) {
    _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", `Using tsconfig: ${tsconfig.path}`);
...
async function build(_options) {
  _chunk5LOHBVWKjs.setSilent.call(void 0, _options.silent);
  _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", `tsup v${version}`);
  const config = await _chunk5LOHBVWKjs.loadTsupConfig.call(void 0, process.cwd());
  if (config.path) {
    _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", `Using tsup config: ${config.path}`);
  }
  const options = await normalizeOptions(config.data, _options);
  if (_options.watch) {
    _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", "Running in watch mode");
  }
  ...
  const debouncedBuildAll = _chunk5LOHBVWKjs.debouncePromise.call(void 0, () => {
    return buildAll();
  }, 100, _chunkJXWWLNOTjs.handleError);
  const buildAll = async () => {
    const killPromise = killPreviousProcess();
    if (options.clean) {
      await _chunk5LOHBVWKjs.removeFiles.call(void 0, ["**/*", "!**/*.d.ts"], options.outDir);
      _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", "Cleaning output folder");
    }
    const css = new Map();
    await Promise.all([
  ...
  const startWatcher = async () => {
    if (!options.watch)
      return;
    const {watch} = await Promise.resolve().then(() => _chunkAV6ARAKLjs.__toModule.call(void 0, require("chokidar")));
    ...
    _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", `Watching for changes in ${Array.isArray(watchPaths) ? watchPaths.map((v) => '"' + v + '"').join(" | ") : '"' + watchPaths + '"'}`);
    _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", `Ignoring changes in ${ignored.map((v) => '"' + v + '"').join(" | ")}`);
    ...
    watcher.on("all", async (type, file) => {
      _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", `Change detected: ${type} ${file}`);
      debouncedBuildAll();
    });
  };
  _chunk5LOHBVWKjs.log.call(void 0, "CLI", "info", `Target: ${options.target}`);
  await buildAll();
  startWatcher();
  if (options.dts) {
    ...
    worker.postMessage({
      options: _chunkAV6ARAKLjs.__objSpread.call(void 0, _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, options), {
