...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    const {build} = await Promise.resolve().then(() => _chunkAV6ARAKLjs.__toModule.call(void 0, require("./index.js")));
    Object.assign(options, _chunkAV6ARAKLjs.__objSpread.call(void 0, {}, flags));
    if (files.length > 0) {
