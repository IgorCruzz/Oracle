...
var _pdfmake = require('pdfmake'); var _pdfmake2 = _interopRequireDefault(_pdfmake);
    ...
    content: [
      {
        columns: [
          {
            image: _path.resolve.call(void 0, __dirname, '..', '..', 'utils', 'img', 'ieea.png'),
            width: 70,
            height: 20,
            margin: [0, 30, 20, 5],
          },
          ...
          {
            image: _path.resolve.call(void 0, __dirname, '..', '..', 'utils', 'img', 'logo.png'),
            width: 100,
            height: 50,
            margin: [0, 5, 20, 5],
          },
          ...
          {
            image: _path.resolve.call(void 0, __dirname, '..', '..', 'utils', 'img', 'rj.png'),
            width: 100,
            height: 50,
            margin: [0, 5, 20, 5],
          },
          {
            image: _path.resolve.call(void 0, __dirname, '..', '..', 'utils', 'img', 'puc.jpg'),
            width: 70,
            height: 50,
            margin: [0, 5, 20, 5],
          },
