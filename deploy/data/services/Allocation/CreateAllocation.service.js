...
var _database = require('../../database');
 ...
 class CreateAllocationService {
  async execute(data) {
    ...
    const productHistory = new (0, _repositories.ProductRepository)();
      ...
      await Promise.all(
        await data.allocations.map(
          async ({ id_allocation_period, id_product, id_professional }) => {
            ...
            const calculate = _calculateHour.calculateHour.call(void 0, {
              ...
              if (
                ...
                await productHistoryRepository.createProductHistory({
                  ...
                  id_previous_professional:
                    professional !== id_professional ? professional : null,
                  id_analyst_user: null,
                  transaction: t,
                });
...
} exports.CreateAllocationService = CreateAllocationService;
