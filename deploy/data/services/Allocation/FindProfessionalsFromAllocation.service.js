...
var _models = require('../../database/models');
 ...
 class FindProfessionalsFromAllocationService {
  async execute({
    page,
    limit,
    ...
    const professionals = await _models.Professional.findAndCountAll({
      where: searchQuery
        ? {
            [_sequelize.Op.and]: [searchQuery, { in_active: 'S' }],
          }
        : {
            in_active: 'S',
          },
...
} exports.FindProfessionalsFromAllocationService = FindProfessionalsFromAllocationService;
