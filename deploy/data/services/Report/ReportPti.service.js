 ...
 class ReportPtiService {
  async execute({ page, limit, id_allocation_period, download }) {
    ...
    if (download) {
      ...
      // /////////////////////////////////////////////////////////
      const getAllocation = await _models.Allocation_period.findByPk(
        id_allocation_period
      );
      ...
      worksheet.getCell('B6').value = `${_datefns.format.call(void 0, 
        _datefns.addDays.call(void 0, new Date(getAllocation.dt_start_allocation), 1),
        'dd/MM/yyyy'
      )} - ${_datefns.format.call(void 0, 
        _datefns.addDays.call(void 0, new Date(getAllocation.dt_end_allocation), 1),
        'dd/MM/yyyy'
...
} exports.ReportPtiService = ReportPtiService;
